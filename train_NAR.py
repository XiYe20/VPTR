...
if __name__ == '__main__':
    ...
    dev_set_size = None
    bair_crop = False
    train_loader, val_loader, test_loader, renorm_transform = get_dataloader(data_set_name, N, dataset_dir, test_past_frames, test_future_frames, dev_set_size, bair_crop)
